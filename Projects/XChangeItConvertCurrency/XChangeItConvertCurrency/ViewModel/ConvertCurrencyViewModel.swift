...
public final class ConvertCurrencyViewModel: ConvertCurrencyViewModelInterface {
    ...
    // MARK: Public API
    public var observeKeyboardInputChanges: ((_ amount: String) -> ())?
    public var observeDataState: ((_ state: ConvertCurrencyVMDataState) -> ())?
    
    public init(service: ConvertCurrencyServiceInterface) {
        self.service = service
    }
    
    public func handleKeyboardInput(symbol: KeyboardButtonType) {
        parseKeyboardInputToStringCurrency(symbol: symbol)
    }
    
    public func updateCurrenciesTypes(source: CurrencyType, target: CurrencyType) {
